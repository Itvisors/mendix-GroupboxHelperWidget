                        ...
                        if (domClass.contains(node, "mx-groupbox-body")) {
                            if (node.previousElementSibling) {
                                ...
                                if (
                                    ...
                                    headerContainerTable = document.createElement(
                                        "table"
                                    );
                                    headerContainerTable.style.width = "100%";
                                    headerContainerTableRow = document.createElement(
                                        "tr"
                                    );
                                    headerContainerTable.appendChild(
                                        headerContainerTableRow
                                    );
                                    headerContainerLeftTd = document.createElement(
                                        "td"
                                    );
                                    headerContainerTableRow.appendChild(
                                        headerContainerLeftTd
                                    );
                                    headerContainerRightTd = document.createElement(
                                        "td"
                                    );
                                    headerContainerTableRow.appendChild(
                                        headerContainerRightTd
                                    );
                                    headerContainerLeftTd.appendChild(
                                        nodeToMove
                                    );
                                    domConstruct.place(
                                    ...
                                    headerContainerRightTd.appendChild(
                                        headerIconNode
                                    );
                                    if (
                                        thisObj.attributeValue &&
                            ...
                            console.warn(
                                "GroupboxHelperWidget: Parent is not a groupbox"
                            );
                        }
                    } else {
                        console.warn(
                            "GroupboxHelperWidget: No previous sibling found"
                        );
                    }
                }, 100);
            },
